 ...
 */
package com.indigene.employee.forms;
...
public class EmployeeRegistrationDTO implements Serializable{
    ...
    private String read_d;
    private String write_d_name;
    private String speak_d;
    ...
    public String getRead_d() {
        return read_d;
    }

    public void setRead_d(String read_d) {
        this.read_d = read_d;
    }
    ...
    public String getSpeak_d() {
        return speak_d;
    }

    public void setSpeak_d(String speak_d) {
        this.speak_d = speak_d;
    }
    ...
    public String getWrite_d_name() {
        return write_d_name;
    }

    public void setWrite_d_name(String write_d_name) {
        this.write_d_name = write_d_name;
    }
