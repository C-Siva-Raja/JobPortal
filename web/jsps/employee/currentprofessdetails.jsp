<%-- 
    Document   : currentprofessdetails
    Created on : 20 Sep, 2012, 1:46:10 PM
    Author     : sivaraja
--%>
                        ...
                        <table width="100%"	>
                            <tr>
                                <td width="750px"  valign="top">
                                    ...
                                    <table width="100%" id="body_start" cellpadding="3">
                                        <!--body content left -->	
                                        <tr><td colspan="2"><strong>Current Professional Details</strong></td></tr>
                                        <tr><td>&nbsp;</td></tr>

                                        <tr><td><table width="100%" cellpadding="3" id="body_start">

                                                    <tr><td  align="left"><span class="td_field_lable">Employee Name</span></td><td><input type="text" size="30" name="empname"></td></tr>
                                                    ...
                                                    <tr><td align="left"><span class="td_field_lable">Total Exp</td></span><td><select name="years">
                                                    ...
                                                    <tr><td align="left"><span class="td_field_lable">Current Industry</span></td><td><select name="currentindustry">
                                                    ...
                                                    <tr><td align="left"><span class="td_field_lable">key Skills</span></td><td><input type="text" size="32" name="keyskills"> </td></tr>
                                                    <tr><td align="left"><span class="td_field_lable">Designation</span></td><td><input type="text" size="32" name="desg"></td></tr>
                                                    <tr><td align="left"><span class="td_field_lable">Job Profile</span></td><td><textarea name="jobprofile"></textarea></td></tr>
