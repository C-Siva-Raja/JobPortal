<%-- 
    ...
    Created on : 22 Sep, 2012, 7:54:27 PM
    Author     : rajesh
--%>
    ...
    <body>
        <table align="center" width="1000px" id="main_table">
           ...
           <tr><td><font color="red">*</font>Address2 </td><td> <textarea name="add2" cols="30" rows="2"></textarea></td></tr>
                          ...
                          <tr><td><font color="red">*</font>State </td><td><select name="state" >
										<option>-Select-</option>
                          ...
                          <tr><td><font color="red">*</font>City </td><td><select name="city">
										<option>-Select-</option>
                          ...
                          <tr><td><font color="red">*</font>Zip Code </td><td><input type="text" name="zipcode" ></td></tr>
                          <tr><td><font color="red">*</font>Contact Number </td><td><input type="text" name="numb" />						
						</td></tr>
                          <tr><td><font color="red">*</font>Contact Person </td><td><input type="text" name="contperson"/></td></tr>
  			 	<tr><td></td></tr> 
			   <tr><td><input type="checkbox" name="contperson"/>&nbsp;I agree Terms & Conditions</td></tr>
                            <tr><td colspan="2"><input type="checkbox" name="receive" checked="checked"/>&nbsp;I want to receive promotions on my email id</td></tr>
                            <tr><td></td></tr></table>
                   <table align="center">        
                                <tr><td align="center" ><input type="submit" value="Register"/>&nbsp;&nbsp;<input type="reset" value="Clear"/></td></tr>
  			 	</table>
               </td></tr>
